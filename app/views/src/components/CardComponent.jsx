      ...
      <div className="w-full h-full flex justify-center">
        <div className="bg-white w-12/12 rounded-md">
          <div className="card-image w-full">
            <img className="object-cover w-full h-80 rounded-t-md" src={ BASE_URL_IMAGE + "blogs/" + blog.image} alt="card component" srcset="" />
          </div>
          <div className="card-body py-4">
            <h1 className="font-poppins capitalize font-medium text-2xl">{blog.title}</h1>
            ...
            <p className="text-justify font-poppins text-lg font-normal ">
              {desc}{' '}
              <Link to={'#'} className="text-gray-500 font-poppins font-normal">
                read more ...
              </Link>{' '}
            </p>
          </div>
